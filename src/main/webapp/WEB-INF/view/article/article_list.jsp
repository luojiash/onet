...
<div class="container">
	<div class="row">
		...
		<div class="col-md-9">
			<div class="">
              <c:if test="${trash }">
              <button class="btn btn-default" id="clear-trash" type="submit">清空回收站</button>
              </c:if>
              <c:if test="${not trash }">
              <a class="btn btn-default" href="/article/edit">写文章</a>
              </c:if>
			</div>
            <hr>
            <div class="row" id="article-list">
              <c:forEach items="${articleRes.list }" var="article">
